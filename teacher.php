...
$user_account_username = $_GET['username'];
$sql = "SELECT * FROM `user_profiles` WHERE `user_account_username` = '$user_account_username' AND `user_type` = 'User'";
    ...
    <div class="container-fluid">
        ...
        <div class="tab-content" id="myTabContent">
            ...
            <div class="tab-pane fade" id="timeline-tab-pane" role="tabpanel" aria-labelledby="timeline-tab" tabindex="0">
                <?php include './teacher/timeline.php'; ?>
            </div>
